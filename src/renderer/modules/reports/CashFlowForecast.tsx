      ...
      {data && !loading && (
        <>
          ...
          {dangerCrossed && (
            <div style={{
              padding: 12,
              border: '1px solid var(--color-warning, var(--color-accent-warning))',
              borderLeft: '3px solid var(--color-warning, var(--color-accent-warning))',
              ...
              <AlertTriangle size={16} style={{ color: 'var(--color-warning, var(--color-accent-warning))', flexShrink: 0, marginTop: 2 }} />
              <div>
