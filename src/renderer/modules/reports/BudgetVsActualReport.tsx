...
const BudgetVsActualReport: React.FC = () => {
  ...
  const handlePrint = async () => {
    ...
    const utilizationColor = parseFloat(utilizationPct) > 100 ? 'var(--color-accent-expense)' : parseFloat(utilizationPct) > 85 ? 'var(--color-accent-warning)' : 'var(--color-accent-income)';
