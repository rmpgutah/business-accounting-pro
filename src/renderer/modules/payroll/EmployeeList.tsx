...
const COLORS = ['var(--color-accent-blue)', 'var(--color-accent-purple)', 'var(--color-accent-income)', 'var(--color-accent-warning)', 'var(--color-accent-expense)', '#0891b2', '#4f46e5', 'var(--color-accent-warning)'];
