      ...
      <div className="grid grid-cols-2 gap-6">
        <div className="space-y-4">
          ...
          <div className="block-card space-y-3">
            ...
            <div className="bg-bg-primary border border-border-primary p-3 flex items-start gap-2" style={{ borderRadius: 'var(--app-radius)' }}>
        ...
        <div className="block-card space-y-4">
          ...
          <div className="space-y-3">
            <div className="flex items-start gap-3">
              <span className="w-5 h-5 flex items-center justify-center bg-accent-blue text-white text-xs font-bold shrink-0" style={{ borderRadius: 'var(--app-radius)' }}>1</span>
              <p className="text-xs text-text-secondary">
                Go to <span className="text-text-primary font-medium">Settings &gt; Integrations</span> and enable the companion web server.
              </p>
            </div>
            <div className="flex items-start gap-3">
              <span className="w-5 h-5 flex items-center justify-center bg-accent-blue text-white text-xs font-bold shrink-0" style={{ borderRadius: 'var(--app-radius)' }}>2</span>
              <p className="text-xs text-text-secondary">
            ...
            <div className="flex items-start gap-3">
              <span className="w-5 h-5 flex items-center justify-center bg-accent-blue text-white text-xs font-bold shrink-0" style={{ borderRadius: 'var(--app-radius)' }}>3</span>
              <p className="text-xs text-text-secondary">
          ...
          <div className="bg-bg-primary border border-border-primary p-3" style={{ borderRadius: 'var(--app-radius)' }}>
