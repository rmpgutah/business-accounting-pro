...
const api = {
  ...
  vnDashboard: (vendorId: string) => window.electronAPI.invoke('vn:dashboard', { vendorId }),
  vnProfile: (vendorId: string) => window.electronAPI.invoke('vn:profile', { vendorId }),
  vnExpenses: (vendorId: string, limit?: number) => window.electronAPI.invoke('vn:expenses', { vendorId, limit }),
  vnBills: (vendorId: string) => window.electronAPI.invoke('vn:bills', { vendorId }),
  vnPOs: (vendorId: string) => window.electronAPI.invoke('vn:pos', { vendorId }),
  vnSpendByMonth: (vendorId: string, months?: number) => window.electronAPI.invoke('vn:spend-by-month', { vendorId, months }),
  vnSpendByCategory: (vendorId: string) => window.electronAPI.invoke('vn:spend-by-category', { vendorId }),
  vnPaymentMethods: (vendorId: string) => window.electronAPI.invoke('vn:payment-methods', { vendorId }),
  vnAvgTransaction: (vendorId: string) => window.electronAPI.invoke('vn:avg-transaction', { vendorId }),
  vnYoYSpend: (vendorId: string) => window.electronAPI.invoke('vn:yoy-spend', { vendorId }),
  vn1099Status: (vendorId: string) => window.electronAPI.invoke('vn:1099-status', { vendorId }),
  vnContractInfo: (vendorId: string) => window.electronAPI.invoke('vn:contract-info', { vendorId }),
  vnInsuranceInfo: (vendorId: string) => window.electronAPI.invoke('vn:insurance-info', { vendorId }),
  vnComplianceDocs: (vendorId: string) => window.electronAPI.invoke('vn:compliance-docs', { vendorId }),
  vnW9Status: (vendorId: string) => window.electronAPI.invoke('vn:w9-status', { vendorId }),
  vnScorecard: (vendorId: string) => window.electronAPI.invoke('vn:scorecard', { vendorId }),
  vnRanking: (limit?: number) => window.electronAPI.invoke('vn:ranking', { limit }),
  vnConcentration: () => window.electronAPI.invoke('vn:concentration'),
  vnGrowthTrend: (vendorId: string) => window.electronAPI.invoke('vn:growth-trend', { vendorId }),
  vnFrequency: (vendorId: string) => window.electronAPI.invoke('vn:frequency', { vendorId }),
  vnList: () => window.electronAPI.invoke('vn:list'),
  vnSearch: (query: string) => window.electronAPI.invoke('vn:search', { query }),
  vnByType: () => window.electronAPI.invoke('vn:by-type'),
  vnByStatus: () => window.electronAPI.invoke('vn:by-status'),
  vnByApproval: () => window.electronAPI.invoke('vn:by-approval'),
  vnByLocation: () => window.electronAPI.invoke('vn:by-location'),
  vnExpiredInsurance: () => window.electronAPI.invoke('vn:expired-insurance'),
  vnExpiredContracts: () => window.electronAPI.invoke('vn:expired-contracts'),
  vnNeeding1099: () => window.electronAPI.invoke('vn:needing-1099'),
  vnWithoutW9: () => window.electronAPI.invoke('vn:without-w9'),
  vnInactive: (days?: number) => window.electronAPI.invoke('vn:inactive', { days }),
  vnNewVendors: (days?: number) => window.electronAPI.invoke('vn:new-vendors', { days }),
  vnCount: () => window.electronAPI.invoke('vn:count'),
  vnExport: () => window.electronAPI.invoke('vn:export'),
  vnBillSummary: (vendorId: string) => window.electronAPI.invoke('vn:bill-summary', { vendorId }),
  vnPaymentHistory: (vendorId: string) => window.electronAPI.invoke('vn:payment-history', { vendorId }),
  vnAvgPaymentDays: (vendorId: string) => window.electronAPI.invoke('vn:avg-payment-days', { vendorId }),
  vnBillsByMonth: (vendorId: string) => window.electronAPI.invoke('vn:bills-by-month', { vendorId }),
  vnUpcomingBills: (vendorId: string, days?: number) => window.electronAPI.invoke('vn:upcoming-bills', { vendorId, days }),
  vnPOSummary: (vendorId: string) => window.electronAPI.invoke('vn:po-summary', { vendorId }),
  vnNotes: (vendorId: string) => window.electronAPI.invoke('vn:notes', { vendorId }),
  vnNoteAdd: (vendorId: string, note: string, createdBy?: string) => window.electronAPI.invoke('vn:note-add', { vendorId, note, createdBy }),
  vnEmailHistory: (vendorId: string) => window.electronAPI.invoke('vn:email-history', { vendorId }),
  vnActivityLog: (vendorId: string) => window.electronAPI.invoke('vn:activity-log', { vendorId }),
  vnRelated: (vendorId: string) => window.electronAPI.invoke('vn:related', { vendorId }),
  vnFullSnapshot: (vendorId: string) => window.electronAPI.invoke('vn:full-snapshot', { vendorId }),
  vnHealthCheck: () => window.electronAPI.invoke('vn:health-check'),
  vnSpendForecast: (vendorId: string) => window.electronAPI.invoke('vn:spend-forecast', { vendorId }),
  vnComparison: (vendorIds: string[]) => window.electronAPI.invoke('vn:comparison', { vendorIds }),
  vnAllScores: () => window.electronAPI.invoke('vn:all-scores'),
  vnDiversity: () => window.electronAPI.invoke('vn:diversity'),
  ...
  vnAchRiskFlags: (withinDays?: number) => window.electronAPI.invoke('vn:ach-risk-flags', { withinDays }),
  vnDuplicateVendors: () => window.electronAPI.invoke('vn:duplicate-vendors'),
  ...
  dcByStage: () => window.electronAPI.invoke('dc:by-stage'),
  dcByPriority: () => window.electronAPI.invoke('dc:by-priority'),
  dcByStatus: () => window.electronAPI.invoke('dc:by-status'),
  dcAgingBuckets: () => window.electronAPI.invoke('dc:aging-buckets'),
  dcCollectionRate: () => window.electronAPI.invoke('dc:collection-rate'),
  dcMonthlyCollections: (months?: number) => window.electronAPI.invoke('dc:monthly-collections', { months }),
  dcTopDebtors: (limit?: number) => window.electronAPI.invoke('dc:top-debtors', { limit }),
  dcTrend: () => window.electronAPI.invoke('dc:trend'),
  dcRecoveryForecast: () => window.electronAPI.invoke('dc:recovery-forecast'),
  dcCollectorPerformance: () => window.electronAPI.invoke('dc:collector-performance'),
  dcSearch: (query: string) => window.electronAPI.invoke('dc:search', { query }),
  dcByType: () => window.electronAPI.invoke('dc:by-type'),
  dcByJurisdiction: () => window.electronAPI.invoke('dc:by-jurisdiction'),
  dcSkipTraces: (debtId: string) => window.electronAPI.invoke('dc:skip-traces', { debtId }),
  dcSkipTraceCreate: (trace: any) => window.electronAPI.invoke('dc:skip-trace:create', trace),
  dcSkipTraceUpdate: (id: string, data: any) => window.electronAPI.invoke('dc:skip-trace:update', { id, ...data }),
  dcSkipTraceDelete: (id: string) => window.electronAPI.invoke('dc:skip-trace:delete', { id }),
  dcSkipTraceSummary: () => window.electronAPI.invoke('dc:skip-trace-summary'),
  dcWriteoffs: () => window.electronAPI.invoke('dc:writeoffs'),
  dcWriteoffCreate: (wo: any) => window.electronAPI.invoke('dc:writeoff:create', wo),
  dcWriteoffSummary: () => window.electronAPI.invoke('dc:writeoff-summary'),
  dcWriteoffDelete: (id: string) => window.electronAPI.invoke('dc:writeoff:delete', { id }),
  dcWriteoffByReason: () => window.electronAPI.invoke('dc:writeoff-by-reason'),
  dcNeedSkipTrace: () => window.electronAPI.invoke('dc:need-skip-trace'),
  dcWriteoffCandidates: (age?: number) => window.electronAPI.invoke('dc:writeoff-candidates', { age }),
  dcRecoveryRate: () => window.electronAPI.invoke('dc:recovery-rate'),
  dcCommHistory: (debtId: string) => window.electronAPI.invoke('dc:comm-history', { debtId }),
  dcCommSummary: () => window.electronAPI.invoke('dc:comm-summary'),
  dcRecentComms: (limit?: number) => window.electronAPI.invoke('dc:recent-comms', { limit }),
  dcNeedContact: (days?: number) => window.electronAPI.invoke('dc:need-contact', { days }),
  dcPromises: () => window.electronAPI.invoke('dc:promises'),
  dcBrokenPromises: () => window.electronAPI.invoke('dc:broken-promises'),
  dcUpcomingPromises: (days?: number) => window.electronAPI.invoke('dc:upcoming-promises', { days }),
  dcNotes: (debtId: string) => window.electronAPI.invoke('dc:notes', { debtId }),
  dcNoteCreate: (note: any) => window.electronAPI.invoke('dc:note:create', note),
  dcNoteDelete: (id: string) => window.electronAPI.invoke('dc:note:delete', { id }),
  dcActivityTimeline: (debtId: string) => window.electronAPI.invoke('dc:activity-timeline', { debtId }),
  dcAuditLogDetail: (debtId: string) => window.electronAPI.invoke('dc:audit-log-detail', { debtId }),
  dcDisputes: () => window.electronAPI.invoke('dc:disputes'),
  dcOpenDisputes: () => window.electronAPI.invoke('dc:open-disputes'),
  dcEvidence: (debtId: string) => window.electronAPI.invoke('dc:evidence', { debtId }),
  dcLegalActions: (debtId: string) => window.electronAPI.invoke('dc:legal-actions', { debtId }),
  dcPaymentHistoryDebt: (debtId: string) => window.electronAPI.invoke('dc:payment-history', { debtId }),
  dcSettlements: () => window.electronAPI.invoke('dc:settlements'),
  dcCampaigns: () => window.electronAPI.invoke('dc:campaigns'),
  dcCampaignUpsert: (c: any) => window.electronAPI.invoke('dc:campaign:upsert', c),
  dcCampaignDelete: (id: string) => window.electronAPI.invoke('dc:campaign:delete', { id }),
  dcCampaignTargets: (campaignId: string) => window.electronAPI.invoke('dc:campaign-targets', { campaignId }),
  dcCampaignSummary: () => window.electronAPI.invoke('dc:campaign-summary'),
  dcAutomationRules: () => window.electronAPI.invoke('dc:automation-rules'),
  dcBatchAdvanceStage: (debtIds: string[], stage: string) => window.electronAPI.invoke('dc:batch-advance-stage', { debtIds, stage }),
  dcBatchAssign: (debtIds: string[], collector: string) => window.electronAPI.invoke('dc:batch-assign', { debtIds, collector }),
  dcBatchPriority: (debtIds: string[], priority: string) => window.electronAPI.invoke('dc:batch-priority', { debtIds, priority }),
  dcBatchWriteOff: (debtIds: string[], reason: string) => window.electronAPI.invoke('dc:batch-writeoff', { debtIds, reason }),
  dcEscalationQueue: () => window.electronAPI.invoke('dc:escalation-queue'),
  dcAutoEscalate: () => window.electronAPI.invoke('dc:auto-escalate'),
  dcScheduledActions: () => window.electronAPI.invoke('dc:scheduled-actions'),
  dcPlanSummary: () => window.electronAPI.invoke('dc:plan-summary'),
  dcInstallmentsDue: (days?: number) => window.electronAPI.invoke('dc:installments-due', { days }),
  dcOverdueInstallments: () => window.electronAPI.invoke('dc:overdue-installments'),
  dcSettlementSummary: () => window.electronAPI.invoke('dc:settlement-summary'),
  dcPendingSettlements: () => window.electronAPI.invoke('dc:pending-settlements'),
  dcPaymentSummary: () => window.electronAPI.invoke('dc:payment-summary'),
  dcAvgSettlementDiscount: () => window.electronAPI.invoke('dc:avg-settlement-discount'),
  dcPaymentMatches: () => window.electronAPI.invoke('dc:payment-matches'),
  dcComplianceLog: (debtId?: string) => window.electronAPI.invoke('dc:compliance-log', { debtId }),
  dcComplianceSummary: () => window.electronAPI.invoke('dc:compliance-summary'),
  dcStatuteExpiring: (days?: number) => window.electronAPI.invoke('dc:statute-expiring', { days }),
  dcCeaseDesist: () => window.electronAPI.invoke('dc:cease-desist'),
  dcFDCPACheck: () => window.electronAPI.invoke('dc:fdcpa-check'),
  dcLegalSummary: () => window.electronAPI.invoke('dc:legal-summary'),
  dcInLegal: () => window.electronAPI.invoke('dc:in-legal'),
  dcBankruptcy: () => window.electronAPI.invoke('dc:bankruptcy'),
  dcContactRestrictions: () => window.electronAPI.invoke('dc:contact-restrictions'),
  dcRiskScore: (debtId: string) => window.electronAPI.invoke('dc:risk-score', { debtId }),
  dcRiskScoresBulk: () => window.electronAPI.invoke('dc:risk-scores-bulk'),
  dcRiskDistribution: () => window.electronAPI.invoke('dc:risk-distribution'),
  dcHighRisk: () => window.electronAPI.invoke('dc:high-risk'),
  dcDebtorProfile: (debtId: string) => window.electronAPI.invoke('dc:debtor-profile', { debtId }),
  dcPortfolioSummary: () => window.electronAPI.invoke('dc:portfolio-summary'),
  dcCollectorWorkload: () => window.electronAPI.invoke('dc:collector-workload'),
  dcStageTransitions: () => window.electronAPI.invoke('dc:stage-transitions'),
  dcExport: () => window.electronAPI.invoke('dc:export'),
  dcMonthlyPerformance: () => window.electronAPI.invoke('dc:monthly-performance'),
  dcConcentration: () => window.electronAPI.invoke('dc:concentration'),
  dcAvgDaysToCollect: () => window.electronAPI.invoke('dc:avg-days-to-collect'),
  dcPortfolioHealth: () => window.electronAPI.invoke('dc:portfolio-health'),
  dcQuarterlyReport: () => window.electronAPI.invoke('dc:quarterly-report'),
  dcFullReport: () => window.electronAPI.invoke('dc:full-report'),

  // ─── System-Wide (SW1–SW150) ────────────────────────────
  swClientDashboard: () => window.electronAPI.invoke('sw:client-dashboard'),
  swClientRevenueRanking: (limit?: number) => window.electronAPI.invoke('sw:client-revenue-ranking', { limit }),
  swClientRetention: () => window.electronAPI.invoke('sw:client-retention'),
  swClientAcquisition: (months?: number) => window.electronAPI.invoke('sw:client-acquisition', { months }),
  swClientsByType: () => window.electronAPI.invoke('sw:clients-by-type'),
  swClientContacts: () => window.electronAPI.invoke('sw:client-contacts'),
  swClientsNoInvoices: () => window.electronAPI.invoke('sw:clients-no-invoices'),
  swClientGeography: () => window.electronAPI.invoke('sw:client-geography'),
  swTopClientsExpenses: () => window.electronAPI.invoke('sw:top-clients-expenses'),
  swClientComms: (clientId: string) => window.electronAPI.invoke('sw:client-comms', { clientId }),
  swProjectDashboard: () => window.electronAPI.invoke('sw:project-dashboard'),
  swProjectProfitability: () => window.electronAPI.invoke('sw:project-profitability'),
  swProjectTime: (projectId: string) => window.electronAPI.invoke('sw:project-time', { projectId }),
  swProjectTimeSummary: () => window.electronAPI.invoke('sw:project-time-summary'),
  swProjectBurn: () => window.electronAPI.invoke('sw:project-burn'),
  swProjectsByClient: () => window.electronAPI.invoke('sw:projects-by-client'),
  swProjectMilestones: (projectId: string) => window.electronAPI.invoke('sw:project-milestones', { projectId }),
  swOverBudgetProjects: () => window.electronAPI.invoke('sw:over-budget-projects'),
  swProjectStatus: () => window.electronAPI.invoke('sw:project-status'),
  swProjectActivity: () => window.electronAPI.invoke('sw:project-activity'),
  swInventoryDashboard: () => window.electronAPI.invoke('sw:inventory-dashboard'),
  swLowStock: () => window.electronAPI.invoke('sw:low-stock'),
  swInventoryValuation: () => window.electronAPI.invoke('sw:inventory-valuation'),
  swInventoryMovements: (itemId: string) => window.electronAPI.invoke('sw:inventory-movements', { itemId }),
  swInventoryTurnover: () => window.electronAPI.invoke('sw:inventory-turnover'),
  swInventoryByCategory: () => window.electronAPI.invoke('sw:inventory-by-category'),
  swReorderSuggestions: () => window.electronAPI.invoke('sw:reorder-suggestions'),
  swInventoryAging: () => window.electronAPI.invoke('sw:inventory-aging'),
  swInventorySearch: (query: string) => window.electronAPI.invoke('sw:inventory-search', { query }),
  swInventoryValueTrend: () => window.electronAPI.invoke('sw:inventory-value-trend'),
  swBillsDashboard: () => window.electronAPI.invoke('sw:bills-dashboard'),
  swBillsByVendor: () => window.electronAPI.invoke('sw:bills-by-vendor'),
  swBillsAging: () => window.electronAPI.invoke('sw:bills-aging'),
  swUpcomingBills: (days?: number) => window.electronAPI.invoke('sw:upcoming-bills', { days }),
  swBillPayments: (billId: string) => window.electronAPI.invoke('sw:bill-payments', { billId }),
  swCashOutflowForecast: (weeks?: number) => window.electronAPI.invoke('sw:cash-outflow-forecast', { weeks }),
  swBillsMonthly: () => window.electronAPI.invoke('sw:bills-monthly'),
  swRecurringBills: () => window.electronAPI.invoke('sw:recurring-bills'),
  swBillsSearch: (query: string) => window.electronAPI.invoke('sw:bills-search', { query }),
  swApVsAr: () => window.electronAPI.invoke('sw:ap-vs-ar'),
  swBankReconSummary: () => window.electronAPI.invoke('sw:bank-recon-summary'),
  swUnmatchedTxns: (limit?: number) => window.electronAPI.invoke('sw:unmatched-txns', { limit }),
  swBankBalanceHistory: (accountId: string) => window.electronAPI.invoke('sw:bank-balance-history', { accountId }),
  swTxnsByCategory: () => window.electronAPI.invoke('sw:txns-by-category'),
  swReconProgress: () => window.electronAPI.invoke('sw:recon-progress'),
  swSettingsList: () => window.electronAPI.invoke('sw:settings-list'),
  swSettingGet: (key: string) => window.electronAPI.invoke('sw:setting-get', { key }),
  swSettingSet: (key: string, value: string) => window.electronAPI.invoke('sw:setting-set', { key, value }),
  swCompanyProfile: () => window.electronAPI.invoke('sw:company-profile'),
  swSystemHealth: () => window.electronAPI.invoke('sw:system-health'),
  swAssetDashboard: () => window.electronAPI.invoke('sw:asset-dashboard'),
  swAssetsByCategory: () => window.electronAPI.invoke('sw:assets-by-category'),
  swAssetsDepreciation: () => window.electronAPI.invoke('sw:assets-depreciation'),
  swAssetDepreciationSchedule: (assetId: string) => window.electronAPI.invoke('sw:asset-depreciation-schedule', { assetId }),
  swAssetsWarranty: (days?: number) => window.electronAPI.invoke('sw:assets-warranty', { days }),
  swAssetInsurance: () => window.electronAPI.invoke('sw:asset-insurance'),
  swRecentDisposals: () => window.electronAPI.invoke('sw:recent-disposals'),
  swAssetSearch: (query: string) => window.electronAPI.invoke('sw:asset-search', { query }),
  swTotalAssetValue: () => window.electronAPI.invoke('sw:total-asset-value'),
  swAssetsByLocation: () => window.electronAPI.invoke('sw:assets-by-location'),
  swBudgetDashboard: () => window.electronAPI.invoke('sw:budget-dashboard'),
  swBudgetVsActual: (budgetId: string) => window.electronAPI.invoke('sw:budget-vs-actual', { budgetId }),
  swBudgetUtilization: () => window.electronAPI.invoke('sw:budget-utilization'),
  swOverBudgetCategories: () => window.electronAPI.invoke('sw:over-budget-categories'),
  swBudgetForecast: () => window.electronAPI.invoke('sw:budget-forecast'),
  swBudgetsList: () => window.electronAPI.invoke('sw:budgets-list'),
  swBudgetLines: (budgetId: string) => window.electronAPI.invoke('sw:budget-lines', { budgetId }),
  swBudgetCreate: (budget: any) => window.electronAPI.invoke('sw:budget-create', budget),
  swBudgetLineAdd: (budgetId: string, line: any) => window.electronAPI.invoke('sw:budget-line-add', { budgetId, ...line }),
  swBudgetLineDelete: (id: string) => window.electronAPI.invoke('sw:budget-line-delete', { id }),
  swDocDashboard: () => window.electronAPI.invoke('sw:doc-dashboard'),
  swDocSearch: (query: string) => window.electronAPI.invoke('sw:doc-search', { query }),
  swDocsByEntity: (entityType: string, entityId: string) => window.electronAPI.invoke('sw:docs-by-entity', { entityType, entityId }),
  swRecentDocs: (limit?: number) => window.electronAPI.invoke('sw:recent-docs', { limit }),
  swEmailDashboard: () => window.electronAPI.invoke('sw:email-dashboard'),
  swEmailHistoryList: (limit?: number) => window.electronAPI.invoke('sw:email-history', { limit }),
  swEmailByRecipient: () => window.electronAPI.invoke('sw:email-by-recipient'),
  swNotificationStats: () => window.electronAPI.invoke('sw:notification-stats'),
  swAuditSummary: (days?: number) => window.electronAPI.invoke('sw:audit-summary', { days }),
  swAuditSearch: (query: string) => window.electronAPI.invoke('sw:audit-search', { query }),
  swTimeDashboard: () => window.electronAPI.invoke('sw:time-dashboard'),
  swTimeByEmployee: (opts?: any) => window.electronAPI.invoke('sw:time-by-employee', opts || {}),
  swTimeByProject: () => window.electronAPI.invoke('sw:time-by-project'),
  swUnbilledTime: () => window.electronAPI.invoke('sw:unbilled-time'),
  swWeeklyTime: () => window.electronAPI.invoke('sw:weekly-time'),
  swQuotesDashboard: () => window.electronAPI.invoke('sw:quotes-dashboard'),
  swQuotesByStatus: () => window.electronAPI.invoke('sw:quotes-by-status'),
  swQuoteFunnel: () => window.electronAPI.invoke('sw:quote-funnel'),
  swTopQuotes: (limit?: number) => window.electronAPI.invoke('sw:top-quotes', { limit }),
  swExpiredQuotes: () => window.electronAPI.invoke('sw:expired-quotes'),
  swAutomationsDashboard: () => window.electronAPI.invoke('sw:automations-dashboard'),
  swRuleHistory: (limit?: number) => window.electronAPI.invoke('sw:rule-history', { limit }),
  swCrossModuleSummary: () => window.electronAPI.invoke('sw:cross-module-summary'),
  swRecentActivity: (limit?: number) => window.electronAPI.invoke('sw:recent-activity', { limit }),
  swCashFlowSummary: () => window.electronAPI.invoke('sw:cash-flow-summary'),
  swTaxSummaryYTD: () => window.electronAPI.invoke('sw:tax-summary-ytd'),
  swUpcomingDeadlines: (days?: number) => window.electronAPI.invoke('sw:upcoming-deadlines', { days }),
  swGlobalSearchV2: (query: string) => window.electronAPI.invoke('sw:global-search-v2', { query }),
  swDataIntegrity: () => window.electronAPI.invoke('sw:data-integrity'),
  swFullReport: () => window.electronAPI.invoke('sw:full-report'),
  swTaxDashboard: () => window.electronAPI.invoke('sw:tax-dashboard'),
  swTaxPayments: () => window.electronAPI.invoke('sw:tax-payments'),
  swTaxCategories: () => window.electronAPI.invoke('sw:tax-categories'),
  swSalesTaxLiability: () => window.electronAPI.invoke('sw:sales-tax-liability'),
  swDeductibleSummary: (year?: number) => window.electronAPI.invoke('sw:deductible-summary', { year }),
  swEstimatedTax: () => window.electronAPI.invoke('sw:estimated-tax'),
  sw1099Summary: (year?: number) => window.electronAPI.invoke('sw:1099-summary', { year }),
  swPayrollTaxYTD: () => window.electronAPI.invoke('sw:payroll-tax-ytd'),
  swTaxCalendar: () => window.electronAPI.invoke('sw:tax-calendar'),
  swTaxRates: (state?: string) => window.electronAPI.invoke('sw:tax-rates', { state }),
  swPODashboard: () => window.electronAPI.invoke('sw:po-dashboard'),
  swPOByVendor: () => window.electronAPI.invoke('sw:po-by-vendor'),
  swPOByStatus: () => window.electronAPI.invoke('sw:po-by-status'),
  swOverduePOs: () => window.electronAPI.invoke('sw:overdue-pos'),
  swPOSearch: (query: string) => window.electronAPI.invoke('sw:po-search', { query }),
  swPOMonthly: () => window.electronAPI.invoke('sw:po-monthly'),
  swPOLines: (poId: string) => window.electronAPI.invoke('sw:po-lines', { poId }),
  swPOReceiving: () => window.electronAPI.invoke('sw:po-receiving'),
  swPOToBill: (poId: string) => window.electronAPI.invoke('sw:po-to-bill', { poId }),
  swPOApprovalStatus: () => window.electronAPI.invoke('sw:po-approval-status'),
  swKPIOverview: () => window.electronAPI.invoke('sw:kpi-overview'),
  swRevVsExpTrend: (months?: number) => window.electronAPI.invoke('sw:rev-vs-exp-trend', { months }),
  swProfitMarginTrend: () => window.electronAPI.invoke('sw:profit-margin-trend'),
  swOperatingMetrics: () => window.electronAPI.invoke('sw:operating-metrics'),
  swQuickRatios: () => window.electronAPI.invoke('sw:quick-ratios'),
  swMoMGrowth: () => window.electronAPI.invoke('sw:mom-growth'),
  swBurnRate: () => window.electronAPI.invoke('sw:burn-rate'),
  swRevenueByService: () => window.electronAPI.invoke('sw:revenue-by-service'),
  swTopExpenseCategories: () => window.electronAPI.invoke('sw:top-expense-cats'),
  swFinancialSnapshot: () => window.electronAPI.invoke('sw:financial-snapshot'),
  swStripeSummary: () => window.electronAPI.invoke('sw:stripe-summary'),
  swStripeRecent: (limit?: number) => window.electronAPI.invoke('sw:stripe-recent', { limit }),
  swStripeMonthly: () => window.electronAPI.invoke('sw:stripe-monthly'),
  swStripeFees: () => window.electronAPI.invoke('sw:stripe-fees'),
  swStripeUnmatched: () => window.electronAPI.invoke('sw:stripe-unmatched'),
  swPaymentMethodStats: () => window.electronAPI.invoke('sw:payment-method-stats'),
  swAvgPaymentSize: () => window.electronAPI.invoke('sw:avg-payment-size'),
  swPaymentsByMonth: () => window.electronAPI.invoke('sw:payments-by-month'),
  swOverduePayments: () => window.electronAPI.invoke('sw:overdue-payments'),
  swPaymentForecast: (weeks?: number) => window.electronAPI.invoke('sw:payment-forecast', { weeks }),
  swCompanyDashboard: () => window.electronAPI.invoke('sw:company-dashboard'),
  swCompanyGrowth: () => window.electronAPI.invoke('sw:company-growth'),
  swCompanyComparison: () => window.electronAPI.invoke('sw:company-comparison'),
  swRecurringRevenue: () => window.electronAPI.invoke('sw:recurring-revenue'),
  swCustomerLTV: () => window.electronAPI.invoke('sw:customer-ltv'),
  swVendorDependency: () => window.electronAPI.invoke('sw:vendor-dependency'),
  swProfitByMonth: () => window.electronAPI.invoke('sw:profit-by-month'),
  swAnnualSummary: (year?: number) => window.electronAPI.invoke('sw:annual-summary', { year }),
  swSystemUsage: () => window.electronAPI.invoke('sw:system-usage'),
  swFullSystemReport: () => window.electronAPI.invoke('sw:full-report'),

  // ─── Invoice Wave 3 (IV1–IV80) ──────────────────────────
  ivCoupons: (activeOnly?: boolean) => window.electronAPI.invoke('iv:coupons', { activeOnly }),
  ivCouponUpsert: (c: any) => window.electronAPI.invoke('iv:coupon:upsert', c),
  ivCouponDelete: (id: string) => window.electronAPI.invoke('iv:coupon:delete', { id }),
  ivCouponRedeem: (code: string, invoiceId: string, invoiceTotal: number) => window.electronAPI.invoke('iv:coupon:redeem', { code, invoiceId, invoiceTotal }),
  ivCouponHistory: () => window.electronAPI.invoke('iv:coupon:history'),
  ivCouponSummary: () => window.electronAPI.invoke('iv:coupon:summary'),
  ivCouponValidate: (code: string) => window.electronAPI.invoke('iv:coupon:validate', { code }),
  ivExpiredCoupons: () => window.electronAPI.invoke('iv:coupon:expired'),
  ivCreditMemos: (clientId?: string) => window.electronAPI.invoke('iv:credit-memos', { clientId }),
  ivCreditMemoCreate: (cm: any) => window.electronAPI.invoke('iv:credit-memo:create', cm),
  ivCreditMemoApply: (memoId: string, toInvoiceId: string) => window.electronAPI.invoke('iv:credit-memo:apply', { memoId, toInvoiceId }),
  ivCreditMemoVoid: (id: string) => window.electronAPI.invoke('iv:credit-memo:void', { id }),
  ivCreditMemoSummary: () => window.electronAPI.invoke('iv:credit-memo:summary'),
  ivClientCredit: (clientId: string) => window.electronAPI.invoke('iv:client-credit', { clientId }),
  ivPaymentPlanCreate: (plan: any) => window.electronAPI.invoke('iv:payment-plan:create', plan),
  ivPaymentPlans: (invoiceId?: string) => window.electronAPI.invoke('iv:payment-plans', { invoiceId }),
  ivPaymentPlanInstallments: (planId: string) => window.electronAPI.invoke('iv:payment-plan:installments', { planId }),
  ivInstallmentPay: (installmentId: string, amount: number) => window.electronAPI.invoke('iv:installment:pay', { installmentId, amount }),
  ivOverdueInstallments: () => window.electronAPI.invoke('iv:installments:overdue'),
  ivPaymentPlanCancel: (planId: string) => window.electronAPI.invoke('iv:payment-plan:cancel', { planId }),
  ivCollectionScore: (invoiceId: string) => window.electronAPI.invoke('iv:collection-score', { invoiceId }),
  ivCollectionScoresBulk: () => window.electronAPI.invoke('iv:collection-scores:bulk'),
  ivCollectionBoard: () => window.electronAPI.invoke('iv:collection-board'),
  ivDSO: (days?: number) => window.electronAPI.invoke('iv:dso', { days }),
  ivDSOByClient: () => window.electronAPI.invoke('iv:dso-by-client'),
  ivDSOTrend: () => window.electronAPI.invoke('iv:dso-trend'),
  ivApprovalRules: () => window.electronAPI.invoke('iv:approval-rules'),
  ivApprovalRuleUpsert: (r: any) => window.electronAPI.invoke('iv:approval-rule:upsert', r),
  ivApprovalRuleDelete: (id: string) => window.electronAPI.invoke('iv:approval-rule:delete', { id }),
  ivSubmitForApproval: (invoiceId: string, submittedBy: string) => window.electronAPI.invoke('iv:submit-for-approval', { invoiceId, submittedBy }),
  ivApprove: (invoiceId: string, approverUserId: string, comment?: string) => window.electronAPI.invoke('iv:approve', { invoiceId, approverUserId, comment }),
  ivApprovalHistory: (invoiceId: string) => window.electronAPI.invoke('iv:approval-history', { invoiceId }),
  ivTemplates: () => window.electronAPI.invoke('iv:templates'),
  ivTemplateUpsert: (t: any) => window.electronAPI.invoke('iv:template:upsert', t),
  ivTemplateDelete: (id: string) => window.electronAPI.invoke('iv:template:delete', { id }),
  ivLineTemplates: () => window.electronAPI.invoke('iv:line-templates'),
  ivLineTemplateUpsert: (lt: any) => window.electronAPI.invoke('iv:line-template:upsert', lt),
  ivLineTemplateDelete: (id: string) => window.electronAPI.invoke('iv:line-template:delete', { id }),
  ivLogEmail: (entry: any) => window.electronAPI.invoke('iv:log-email', entry),
  ivEmailHistory: (invoiceId: string) => window.electronAPI.invoke('iv:email-history', { invoiceId }),
  ivLogView: (entry: any) => window.electronAPI.invoke('iv:log-view', entry),
  ivViewHistory: (invoiceId: string) => window.electronAPI.invoke('iv:view-history', { invoiceId }),
  ivViewStats: () => window.electronAPI.invoke('iv:view-stats'),
  ivUnviewed: () => window.electronAPI.invoke('iv:unviewed'),
  ivAttachments: (invoiceId: string) => window.electronAPI.invoke('iv:attachments', { invoiceId }),
  ivAttachmentAdd: (att: any) => window.electronAPI.invoke('iv:attachment:add', att),
  ivAttachmentDelete: (id: string) => window.electronAPI.invoke('iv:attachment:delete', { id }),
  ivLogActivity: (entry: any) => window.electronAPI.invoke('iv:log-activity', entry),
  ivActivityLog: (invoiceId: string) => window.electronAPI.invoke('iv:activity-log', { invoiceId }),
  ivRecentActivity: (limit?: number) => window.electronAPI.invoke('iv:recent-activity', { limit }),
  ivDashboard: () => window.electronAPI.invoke('iv:dashboard'),
  ivRevenueByMonth: (months?: number) => window.electronAPI.invoke('iv:revenue-by-month', { months }),
  ivCollectionRate: () => window.electronAPI.invoke('iv:collection-rate'),
  ivAvgPaymentDays: () => window.electronAPI.invoke('iv:avg-payment-days'),
  ivByStatus: () => window.electronAPI.invoke('iv:by-status'),
  ivTopClients: (limit?: number) => window.electronAPI.invoke('iv:top-clients', { limit }),
  ivInvoiceAging: () => window.electronAPI.invoke('iv:aging'),
  ivGrowthRate: () => window.electronAPI.invoke('iv:growth-rate'),
  ivAvgSize: () => window.electronAPI.invoke('iv:avg-size'),
  ivByDayOfWeek: () => window.electronAPI.invoke('iv:by-day-of-week'),
  ivSmartFilters: (userId?: string) => window.electronAPI.invoke('iv:smart-filters', { userId }),
  ivSmartFilterUpsert: (f: any) => window.electronAPI.invoke('iv:smart-filter:upsert', f),
  ivSmartFilterDelete: (id: string) => window.electronAPI.invoke('iv:smart-filter:delete', { id }),
  ivWorkflowRules: () => window.electronAPI.invoke('iv:workflow-rules'),
  ivWorkflowRuleUpsert: (r: any) => window.electronAPI.invoke('iv:workflow-rule:upsert', r),
  ivWorkflowRuleDelete: (id: string) => window.electronAPI.invoke('iv:workflow-rule:delete', { id }),
  ivBatchSend: (invoiceIds: string[]) => window.electronAPI.invoke('iv:batch-send', { invoiceIds }),
  ivBatchVoid: (invoiceIds: string[]) => window.electronAPI.invoke('iv:batch-void', { invoiceIds }),
  ivDuplicate: (invoiceId: string) => window.electronAPI.invoke('iv:duplicate', { invoiceId }),
  ivPaymentMethodBreakdown: () => window.electronAPI.invoke('iv:payment-method-breakdown'),
  ivByClient: () => window.electronAPI.invoke('iv:by-client'),
  ivUnpaidSummary: () => window.electronAPI.invoke('iv:unpaid-summary'),
  ivLateFeeReport: () => window.electronAPI.invoke('iv:late-fee-report'),
  ivRecurringSummary: () => window.electronAPI.invoke('iv:recurring-summary'),
  ivExport: (startDate?: string, endDate?: string) => window.electronAPI.invoke('iv:export', { startDate, endDate }),
  ivSearch: (query: string, limit?: number) => window.electronAPI.invoke('iv:search', { query, limit }),
  ivPortalHealth: () => window.electronAPI.invoke('iv:portal-health'),
  ivQuarterly: () => window.electronAPI.invoke('iv:quarterly'),
  ivClientPaymentBehavior: () => window.electronAPI.invoke('iv:client-payment-behavior'),

  // ─── Expense Wave 3 (EX1–EX80) ──────────────────────────
  exAutoSplitProject: (expenseId: string) => window.electronAPI.invoke('ex:auto-split-project', { expenseId }),
  exDetectRecurring: () => window.electronAPI.invoke('ex:detect-recurring'),
  exCategorizationAccuracy: () => window.electronAPI.invoke('ex:categorization-accuracy'),
  exSpendingVelocity: (days?: number) => window.electronAPI.invoke('ex:spending-velocity', { days }),
  exFindDuplicates: () => window.electronAPI.invoke('ex:find-duplicates'),
  exForecastNextMonth: () => window.electronAPI.invoke('ex:forecast-next-month'),
  exVendorAnomalies: (threshold?: number) => window.electronAPI.invoke('ex:vendor-anomalies', { threshold }),
  exUnmatchedReceipts: () => window.electronAPI.invoke('ex:unmatched-receipts'),
  exExpenseAging: () => window.electronAPI.invoke('ex:expense-aging'),
  exAutoTag: (rules: Array<{ keyword: string; tagId: string }>) => window.electronAPI.invoke('ex:auto-tag', { rules }),
  exSpendingByDay: () => window.electronAPI.invoke('ex:spending-by-day'),
  exSubmissionPatterns: () => window.electronAPI.invoke('ex:submission-patterns'),
  exCategoryTrends: () => window.electronAPI.invoke('ex:category-trends'),
  exVendorLoyalty: () => window.electronAPI.invoke('ex:vendor-loyalty'),
  exTaxDeductionSummary: (year?: number) => window.electronAPI.invoke('ex:tax-deduction-summary', { year }),
  exExpenseRevenueRatio: () => window.electronAPI.invoke('ex:expense-revenue-ratio'),
  exSpendingHeatmap: (weeks?: number) => window.electronAPI.invoke('ex:spending-heatmap', { weeks }),
  exMonthlyGrowth: () => window.electronAPI.invoke('ex:monthly-growth'),
  exCategoryConcentration: () => window.electronAPI.invoke('ex:category-concentration'),
  exBudgetBurnRate: () => window.electronAPI.invoke('ex:budget-burn-rate'),
  exCheckPolicy: (expense: { amount: number; category_id?: string }) => window.electronAPI.invoke('ex:check-policy', expense),
  exApprovalChain: (amount: number) => window.electronAPI.invoke('ex:approval-chain', { amount }),
  exBatchApprove: (expenseIds: string[], approvedBy: string) => window.electronAPI.invoke('ex:batch-approve', { expenseIds, approvedBy }),
  exBatchReject: (expenseIds: string[], reason: string) => window.electronAPI.invoke('ex:batch-reject', { expenseIds, reason }),
  exGenerateReport: (opts: { title: string; expenseIds: string[]; submittedBy: string }) => window.electronAPI.invoke('ex:generate-report', opts),
  exVoidExpense: (expenseId: string, reason: string) => window.electronAPI.invoke('ex:void-expense', { expenseId, reason }),
  exSplitExpense: (expenseId: string, splits: any[]) => window.electronAPI.invoke('ex:split-expense', { expenseId, splits }),
  exRequestClarification: (expenseId: string, question: string) => window.electronAPI.invoke('ex:request-clarification', { expenseId, question }),
  exSubmitOnBehalf: (data: any, onBehalfOf: string) => window.electronAPI.invoke('ex:submit-on-behalf', { data, onBehalfOf }),
  exEscalateStale: (days?: number) => window.electronAPI.invoke('ex:escalate-stale', { days }),
  exByEmployee: (opts?: { startDate?: string; endDate?: string }) => window.electronAPI.invoke('ex:by-employee', opts || {}),
  exByPaymentMethod: () => window.electronAPI.invoke('ex:by-payment-method'),
  exYoYComparison: () => window.electronAPI.invoke('ex:yoy-comparison'),
  exLargest: (limit?: number) => window.electronAPI.invoke('ex:largest', { limit }),
  exUncategorized: () => window.electronAPI.invoke('ex:uncategorized'),
  exMissingReceipts: (threshold?: number) => window.electronAPI.invoke('ex:missing-receipts', { threshold }),
  exReimbursementAging: () => window.electronAPI.invoke('ex:reimbursement-aging'),
  exProjectSummary: () => window.electronAPI.invoke('ex:project-summary'),
  exVendorTrend: (vendorId: string) => window.electronAPI.invoke('ex:vendor-trend', { vendorId }),
  exExportCSV: (startDate?: string, endDate?: string) => window.electronAPI.invoke('ex:export-csv', { startDate, endDate }),
  exBillableByClient: () => window.electronAPI.invoke('ex:billable-by-client'),
  exUnmatchedBankTxns: () => window.electronAPI.invoke('ex:unmatched-bank-txns'),
  exLoanLinked: () => window.electronAPI.invoke('ex:loan-linked'),
  exPayrollLinked: () => window.electronAPI.invoke('ex:payroll-linked'),
  exConvertToBill: (expenseId: string) => window.electronAPI.invoke('ex:convert-to-bill', { expenseId }),
  exMarkBillable: (expenseId: string, clientId: string) => window.electronAPI.invoke('ex:mark-billable', { expenseId, clientId }),
  exLinkProjectBudget: (expenseId: string, projectId: string) => window.electronAPI.invoke('ex:link-project-budget', { expenseId, projectId }),
  exCalcMileage: (miles: number, year?: number) => window.electronAPI.invoke('ex:calc-mileage', { miles, year }),
  exConvertCurrency: (amount: number, from: string, to: string, rate: number) => window.electronAPI.invoke('ex:convert-currency', { amount, from, to, rate }),
  exToInvoiceLine: (expenseId: string) => window.electronAPI.invoke('ex:to-invoice-line', { expenseId }),
  exPerDiem: (location: string, days: number, mealsIncluded?: boolean) => window.electronAPI.invoke('ex:per-diem', { location, days, mealsIncluded }),
  exAuditTrail: (expenseId: string) => window.electronAPI.invoke('ex:audit-trail', { expenseId }),
  exPolicyCompliance: () => window.electronAPI.invoke('ex:policy-compliance'),
  exWeekendExpenses: () => window.electronAPI.invoke('ex:weekend-expenses'),
  exRoundNumber: () => window.electronAPI.invoke('ex:round-number'),
  exDeptBudgetVariance: () => window.electronAPI.invoke('ex:dept-budget-variance'),
  exTaxDeductibleBreakdown: (year?: number) => window.electronAPI.invoke('ex:tax-deductible-breakdown', { year }),
  exSubmissionTimeliness: () => window.electronAPI.invoke('ex:submission-timeliness'),
  exEmployeeMonthlySpending: (month?: string) => window.electronAPI.invoke('ex:employee-monthly-spending', { month }),
  exMileageRates: () => window.electronAPI.invoke('ex:mileage-rates'),
  exBatchRecategorize: (expenseIds: string[], categoryId: string) => window.electronAPI.invoke('ex:batch-recategorize', { expenseIds, categoryId }),
  exBatchTaxDeductible: (expenseIds: string[], deductible: boolean) => window.electronAPI.invoke('ex:batch-tax-deductible', { expenseIds, deductible }),
  exBatchAssignProject: (expenseIds: string[], projectId: string) => window.electronAPI.invoke('ex:batch-assign-project', { expenseIds, projectId }),
  exBatchPaymentMethod: (expenseIds: string[], method: string) => window.electronAPI.invoke('ex:batch-payment-method', { expenseIds, method }),
  exDataQuality: (expenseId: string) => window.electronAPI.invoke('ex:data-quality', { expenseId }),
  exBulkDataQuality: () => window.electronAPI.invoke('ex:bulk-data-quality'),
  exMergeVendor: (fromVendorId: string, toVendorId: string) => window.electronAPI.invoke('ex:merge-vendor', { fromVendorId, toVendorId }),
  exFindOrphans: () => window.electronAPI.invoke('ex:find-orphans'),
  exBatchReimburse: (expenseIds: string[]) => window.electronAPI.invoke('ex:batch-reimburse', { expenseIds }),
  exCreateTemplate: (template: any) => window.electronAPI.invoke('ex:create-template', template),
  exDashboardStats: () => window.electronAPI.invoke('ex:dashboard'),
  exRecentVendors: (limit?: number) => window.electronAPI.invoke('ex:recent-vendors', { limit }),
  exRecentCategories: (limit?: number) => window.electronAPI.invoke('ex:recent-categories', { limit }),
  exCountByStatus: () => window.electronAPI.invoke('ex:count-by-status'),
  exAvgProcessingTime: () => window.electronAPI.invoke('ex:avg-processing-time'),
  exTagsSummary: () => window.electronAPI.invoke('ex:tags-summary'),
  exQuarterlyComparison: () => window.electronAPI.invoke('ex:quarterly-comparison'),
  exFullTextSearch: (query: string, limit?: number) => window.electronAPI.invoke('ex:full-text-search', { query, limit }),
  exToggleStar: (expenseId: string) => window.electronAPI.invoke('ex:toggle-star', { expenseId }),
  exPortalHealth: () => window.electronAPI.invoke('ex:portal-health'),
  ...
  // LG: type-specific
  lfIdrCalc: (p: { plan: 'PAYE' | 'REPAYE' | 'IBR_new' | 'IBR_old' | 'ICR'; agi: number; family_size: number; state?: string }) => window.electronAPI.invoke('lf:idr:calc', p),
  lfPslfTrack: (p: { loan_id: string; payment_date: string; qualifies: boolean; reason?: string }) => window.electronAPI.invoke('lf:pslf:track', p),
  lfHelocPhaseCalc: (p: any) => window.electronAPI.invoke('lf:heloc:phase-calc', p),
  lfConstructionProject: (p: any) => window.electronAPI.invoke('lf:construction:project', p),
  lfReverseOptions: (p: any) => window.electronAPI.invoke('lf:reverse:options', p),
  lfCcPayoff: (p: any) => window.electronAPI.invoke('lf:cc:payoff', p),
  lfLeaseVsBuy: (p: any) => window.electronAPI.invoke('lf:lease-vs-buy', p),
  lfAutoAfford: (p: any) => window.electronAPI.invoke('lf:auto:afford', p),
  lfSbaEligible: (p: any) => window.electronAPI.invoke('lf:sba:eligible', p),
  lfMarginCall: (p: any) => window.electronAPI.invoke('lf:margin:call', p),
  // LH: math
  lfPv: (p: { future_value: number; rate_pct: number; periods: number }) => window.electronAPI.invoke('lf:pv', p),
  lfFv: (p: { present_value: number; rate_pct: number; periods: number }) => window.electronAPI.invoke('lf:fv', p),
  lfNpv: (cash_flows: number[], discount_rate_pct: number) => window.electronAPI.invoke('lf:npv', { cash_flows, discount_rate_pct }),
  lfIrr: (cash_flows: number[], max_iter?: number, tolerance?: number) => window.electronAPI.invoke('lf:irr', { cash_flows, max_iter, tolerance }),
  lfAprToApy: (apr_pct: number, compounds?: number) => window.electronAPI.invoke('lf:apr-to-apy', { apr_pct, compounds }),
  lfApyToApr: (apy_pct: number, compounds?: number) => window.electronAPI.invoke('lf:apy-to-apr', { apy_pct, compounds }),
  lfAprWithFees: (p: any) => window.electronAPI.invoke('lf:apr-with-fees', p),
  lfYieldMaintenance: (p: any) => window.electronAPI.invoke('lf:yield-maintenance', p),
  lfDefeasance: (p: any) => window.electronAPI.invoke('lf:defeasance', p),
  lfDuration: (p: any) => window.electronAPI.invoke('lf:duration', p),
  lfCecl: (p: any) => window.electronAPI.invoke('lf:cecl', p),
  lfTaxEquivYield: (p: any) => window.electronAPI.invoke('lf:tax-equiv-yield', p),
  // LI: applications & origination
  lfAppCreate: (p: any) => window.electronAPI.invoke('lf:app:create', p),
  lfPrequal: (p: any) => window.electronAPI.invoke('lf:prequal', p),
  lf1003: (borrower_id: string, application_id: string) => window.electronAPI.invoke('lf:1003', { borrower_id, application_id }),
  lfUnderwritingChecklist: (application_id: string) => window.electronAPI.invoke('lf:underwriting:checklist', { application_id }),
  lfLoanEstimate: (application_id: string) => window.electronAPI.invoke('lf:loan-estimate', { application_id }),
  lfCdGenerate: (loan_id: string) => window.electronAPI.invoke('lf:cd:generate', { loan_id }),
  lfTilGenerate: (loan_id: string) => window.electronAPI.invoke('lf:til:generate', { loan_id }),
  lfPromissoryCreate: (p: any) => window.electronAPI.invoke('lf:promissory:create', p),
  lfCommitteePackage: (application_id: string) => window.electronAPI.invoke('lf:committee:package', { application_id }),
  lfBorrowerUpsert: (p: any) => window.electronAPI.invoke('lf:borrower:upsert', p),
  // LJ: risk & compliance
  lfCreditUpdate: (borrower_id: string, score: number, source?: string) => window.electronAPI.invoke('lf:credit:update', { borrower_id, score, source }),
  lfDti: (borrower_id: string, additional_monthly_payment?: number) => window.electronAPI.invoke('lf:dti', { borrower_id, additional_monthly_payment }),
  lfReservePortfolio: (opts?: any) => window.electronAPI.invoke('lf:reserve:portfolio', opts || {}),
  lfDscrWeighted: () => window.electronAPI.invoke('lf:dscr:weighted'),
  lfHmda: (application_id: string) => window.electronAPI.invoke('lf:hmda', { application_id }),
  lfFairLending: () => window.electronAPI.invoke('lf:fair-lending'),
  lfRiskGradeAssign: (p: any) => window.electronAPI.invoke('lf:risk-grade:assign', p),
  lfWatchlist: () => window.electronAPI.invoke('lf:watchlist'),
  lfChargeOff: (p: any) => window.electronAPI.invoke('lf:charge-off', p),
  lfRecovery: (p: any) => window.electronAPI.invoke('lf:recovery', p),
  // LK: specialized
  lfHelocDraw: (p: any) => window.electronAPI.invoke('lf:heloc:draw', p),
  lfHelocToRepayment: (p: any) => window.electronAPI.invoke('lf:heloc:to-repayment', p),
  lfConstructionDraw: (p: any) => window.electronAPI.invoke('lf:construction:draw', p),
  lfBridgeCalc: (p: any) => window.electronAPI.invoke('lf:bridge:calc', p),
  lfLeaseClassify: (p: any) => window.electronAPI.invoke('lf:lease:classify', p),
  lfSaleLeaseback: (p: any) => window.electronAPI.invoke('lf:sale-leaseback', p),
  lfFactoring: (p: any) => window.electronAPI.invoke('lf:factoring', p),
  lfMca: (p: any) => window.electronAPI.invoke('lf:mca', p),
  lfAfr: (term_category: 'short' | 'mid' | 'long') => window.electronAPI.invoke('lf:afr', { term_category }),
  lfLocTrack: (p: any) => window.electronAPI.invoke('lf:loc:track', p),
  // LL: portfolio
  lfPortfolioAging: () => window.electronAPI.invoke('lf:portfolio:aging'),
  lfPortfolioVintage: () => window.electronAPI.invoke('lf:portfolio:vintage'),
  lfPortfolioConcentration: () => window.electronAPI.invoke('lf:portfolio:concentration'),
  lfNim: (months?: number) => window.electronAPI.invoke('lf:nim', { months }),
  lfLoanYield: (loan_id: string) => window.electronAPI.invoke('lf:loan:yield', { loan_id }),
  lfChargeOffRate: () => window.electronAPI.invoke('lf:charge-off:rate'),
  lfRecoveryRate: () => window.electronAPI.invoke('lf:recovery:rate'),
  lfDelinquencyRate: () => window.electronAPI.invoke('lf:delinquency:rate'),
